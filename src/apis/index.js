...
export const setAuthToken = (token) => axiosAgent.defaults.headers.common['Authorization'] = `Bearer ${token}`;
...
export const addPost = (postInfo) => axiosAgent.post('/blog/add', {
    title: postInfo.title,
    text: postInfo.description
})

export const addDevice = (deviceInfo) => axiosAgent.post('/device/add', {
